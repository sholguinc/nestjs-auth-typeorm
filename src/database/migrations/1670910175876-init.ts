...
export class init1670910175876 implements MigrationInterface {
    name = 'init1670910175876'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "users" (
                ...
                "created_at" TIMESTAMP NOT NULL DEFAULT now(),
                "update_at" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "REL_c7bc1ffb56c570f42053fa7503" UNIQUE ("customer_id"),
        ...
        await queryRunner.query(`
            CREATE TABLE "order-items" (
                ...
                "created_at" TIMESTAMP NOT NULL DEFAULT now(),
                "update_at" TIMESTAMP NOT NULL DEFAULT now(),
                CONSTRAINT "PK_605fbaee38242facaa1a34b67ad" PRIMARY KEY ("id")
            )
        `);
        await queryRunner.query(`
            CREATE TABLE "orders" (
        ...
        await queryRunner.query(`
            CREATE TABLE "products_categories" (
                ...
                CONSTRAINT "PK_634f5e1b5983772473fe0ec0008" PRIMARY KEY ("product_id", "category_id")
            )
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE "users"
            ADD CONSTRAINT "FK_c7bc1ffb56c570f42053fa7503b" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "order-items"
            ADD CONSTRAINT "FK_96c3a0b7ccbd510353f1a3dd500" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "order-items"
            ADD CONSTRAINT "FK_02d2d9fb9489ee7213bcce96770" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "orders"
        ...
        await queryRunner.query(`
            ALTER TABLE "products_categories"
            ADD CONSTRAINT "FK_19fe0fe8c2fcf1cbe1a80f639f1" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "order-items" DROP CONSTRAINT "FK_02d2d9fb9489ee7213bcce96770"
        `);
        await queryRunner.query(`
            ALTER TABLE "order-items" DROP CONSTRAINT "FK_96c3a0b7ccbd510353f1a3dd500"
        `);
        await queryRunner.query(`
